...
const Home = () => {
    ...
    useEffect(() => {
        tm.fromTo(title, .6,{x: -200, opacity: 0, display: 'none'}, {x: 0, opacity: 1, display: 'block'})
        tm.fromTo(titleWrap, .6, {height: '10%', display: 'none'}, {height: '60%', display: 'flex'})
        tm.fromTo(subTitle, .6, {y: -200, opacity:0, display: 'none'}, {y: 0, opacity: 1, display: 'flex', delay: -0.2})
        tm.fromTo(playGame, .6, {x: -200, opacity: 0, display: 'none'}, {x: 0, opacity: 1, display: 'flex', delay: -0.2})
    }, [])
